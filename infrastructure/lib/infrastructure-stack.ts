    ...
    const responseFunction = new Function(
      ...
      'website-cloudfront-viewer-response',
      {
        ...
        function handler(event) {
          ...
          headers['content-security-policy'] = { value: "default-src 'none'; img-src 'self'; font-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://p.trellocdn.com/ https://browser.sentry-cdn.com; style-src 'self' 'unsafe-inline' https://p.trellocdn.com/; object-src 'none'; frame-src https://www.youtube.com https://youtube.com; connect-src 'self' ${webSocketApi.apiEndpoint} https://*.ingest.sentry.io https://*.ingest.us.sentry.io https://*.ingest.eu.sentry.io https://*.ingest.de.sentry.io https://api.trello.com/ https://p.trellocdn.com https://trello.com"};
